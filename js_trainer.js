...
/* 4. Переменная item содержит название свойства для поиска, data содержит объект. Напишите код, который проверяет, существует ли свойство item в объекте data и записывает логический результат true или false в переменную result. */
...
/* 6. Есть переменная stars, которая содержит входные пользовательские данные. Значение переменной stars от 1 до 5. 1 — ★, 2 — ★★, 3 — ★★★, 4 — ★★★★, 5 — ★★★★★. Напишите код, который проверяет значение переменной stars и записывает результат в переменную result. */
